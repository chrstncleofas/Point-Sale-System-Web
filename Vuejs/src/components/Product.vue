<template>
    <div class="item-container">
        <div v-for="product in products" :key="product.id" class="item bg-white mb-5">
            ...
            <button type="submit"
                class="bg-brightRed shadow-box w-20 h-7 rounded mt-4 float-right text-xs text-white">Add
                to Cart</button>
        </div>
    </div>
</template>
